  ...
  <div class="form-container text-light bg-opacity-25">
    ...
    <form method="POST">
      ...
      <div class="input-group">
        ...
        <input type="text" name="nombre" aria-label="First name" placeholder="Nombre" class="form-control if-lenght-3">
        <input type="text" name="apellido" aria-label="Last name" placeholder="Apellido" class="form-control if-lenght-3">
      </div>
      ...
      <div class="input-group mb-3">
        ...
        <input type="text" id="telefono" class="form-control if-lenght-10" placeholder="Número telefonico" aria-label="telefono" aria-describedby="basic-addon1">
      </div>
      ...
      <div class="row g-3 align-items-center">
        ...
        <div class="col-auto">
          <input type="password" id="inputPassword6" class="form-control if-lenght-8" aria-describedby="passwordHelpInline">
        </div>
        <div class="col-auto">
          <span id="passwordHelpInline" class="text-light form-text">
            Minimo 8 caracteres
          </span>
        </div>
