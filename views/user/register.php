    ...
    <form method="POST" id="form-register">
      ...
      <div class="row g-3 align-items-center">
        ...
        <div class="input-group mb-3">
          ...
          <input type="password" name="user[password]" value="<?php echo $user['password'] ?? '' ?>" id="inputPassword" class="form-control if-lenght-8" aria-describedby="passwordHelpInline">
